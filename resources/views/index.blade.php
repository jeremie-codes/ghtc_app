...
@section('content')
    ...
    <section class="hero-section fix hero-3">
        <div class="bottom-shape">
            <img src="{{url('img/hero/bottom-shape.png')}}" alt="shape-img">
        </div>
        ...
        <div class="swiper hero-slider">
            <div class="swiper-wrapper">
                        ...
                        <div class="row g-4 align-items-center">
                            <div class="col-lg-8">
                                <div class="hero-content">
                                    <h5 data-animation="slideInRight" data-duration="2s" data-delay=".3s">Global Hub of Technology In Congo</h5>
                                    <h1 data-animation="slideInRight" data-duration="2s" data-delay=".5s">
                                  Mineral Resource Highlight <br>
                                       
                                    </h1>
                                    <p data-animation="slideInRight" data-duration="2s" data-delay=".9s">
                                    Leveraging the DRC's Position  as a significant player in the global technology landscape <br> attracting international attention and investment.
                                    </p>
                                    <div class="hero-button">

                                        <a href="Javascript:void(0);" data-animation="slideInRight" data-duration="2s" data-delay=".9s" class="theme-btn border-white">
                                            Contact Us
                ...
                <div class="swiper-slide">
                    <div class="slider-image bg-cover" style="background-image: url({{url('img/hero/hero-1.jpg')}})">
                        <div class="mask-shape" data-animation="slideInDown" data-duration="3s" data-delay="2s">
                            <img src="{{url('img/hero/mask-shape-2.png')}}" alt="shape-img">
                        </div>
                        <div class="border-shape" data-animation="slideInRight" data-duration="3s" data-delay="2.2s">
                        ...
                        <div class="row g-4 align-items-center">
                            <div class="col-lg-8">
                                <div class="hero-content">
                                    <h5 data-animation="slideInRight" data-duration="2s" data-delay=".3s">Global Hub of Technology In Congo</h5>
                                    <h1 data-animation="slideInRight" data-duration="2s" data-delay=".5s">
                                   Products Derived from DRC Minerals <br>
                                        
                                    </h1>
                                    <p data-animation="slideInRight" data-duration="2s" data-delay=".9s">
                                 	Showcase the wide range of products derived from DRC minerals, such as <br> batteries, smartphones, laptops, and electric vehicles.
                                    </p>
                                    <div class="hero-button">
                ...
                <div class="swiper-slide">
                    <div class="slider-image bg-cover" style="background-image: url({{url('img/hero/hero-2.jpg')}})">
                        <div class="mask-shape" data-animation="slideInDown" data-duration="3s" data-delay="2s">
                            <img src="{{url('img/hero/mask-shape-2.png')}}" alt="shape-img">
                        </div>
                        <div class="border-shape" data-animation="slideInRight" data-duration="3s" data-delay="2.2s">
                        ...
                        <div class="row g-4 align-items-center" >
                            <div class="col-lg-8">
                                <div class="hero-content">
                                    <h5 data-animation="slideInRight" data-duration="2s" data-delay=".3s">Global Hub of Technology In Congo</h5>
                                    <h1 data-animation="slideInRight" data-duration="2s" data-delay=".5s">
                                   Technology Regulation and Policy <br>
                                      
                                    </h1>
                                    <p data-animation="slideInRight" data-duration="2s" data-delay=".9s">
                                  Advocate for favorable policies and regulations that support the growth of the  <br> technology sector in the DRC
                                    </p>
                                    <div class="hero-button">
                                        <a href="#about.php" data-animation="slideInRight" data-duration="2s" data-delay=".9s" class="theme-btn hover-white">
                                            Explore More
                                            <i class="fa-solid fa-arrow-right-long"></i>
                                        </a>
                                        <a href="Javascript:void(0);" data-animation="slideInRight" data-duration="2s" data-delay=".9s" class="theme-btn border-white">
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0" >
                        <div class="about-content">
                            <div class="section-title" id="about">
                                <span class="wow fadeInUp"> Global Hub of Technology In Congo</span>
                                <h2 class="wow fadeInUp" data-wow-delay=".3s">
                                   Congolese technology 
                                </h2>
                            </div>
                            <p class="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                
                            Global Technology Hub in the Democratic Republic of Congo (DRC) is a central platform that brings together existing and emerging technology hubs across the country that leveraging the DRC's Position the DRC as a significant player in the global technology landscape, attracting international attention and investment.
                            ...
                            <div class="icon-area wow fadeInUp" data-wow-delay=".7s">
                                <ul class="list">
                                    <li>
                                        ...
                                        To establish the Democratic Republic of Congo as a global technology powerhouse... 
                                    </li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="service-card-items">
                            <div class="service-image">
                                <img src="{{url('storage/'.$departement->image)}}" alt="service-img">
                            </div>
                            <div class="icon-2">
                                <img src="{{url('img/service/icon/s-icon-1.svg')}}" alt="img">
                            </div>
                            <div class="service-content">
                                ...
                                <h4>
                                    <a href="Javascript:void(0);">{{$departement->titre}}</a>
                                </h4>
                                <p>
                                Utilize the DRC's mineral resources, such as cobalt and lithium, to develop drones for applications in agriculture, mining, and disaster relief.
                                </p>
                                <a href="{{url('/department/'.$departement->id)}}" class="theme-btn-2 mt-3">
                                    read More
                                    <i class="fa-solid fa-arrow-right-long"></i>
                                </a>
                                <a href="{{url('/department/'.$departement->id)}}" class="theme-btn-2 mt-3">Meet the chief's department<i class="fa-solid fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                @endforeach
  ...
  <!--  <section class="service-section-3 pb-0 fix section-padding bg-cover" style="background-image: url('assets/img/service/service-bg-3.jpg');">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="service-card-items">
                        <div class="service-image">
                            <img src="{{url('img/service/invention.jpg')}}" alt="service-img">
                        </div>
                        <div class="icon-2">
                            <img src="{{url('img/service/icon/s-icon-2.svg')}}" alt="img">
                        </div>
                        <div class="service-content">
                            <div class="icon">
                                <img src="{{url('img/service/icon/s-icon-2.svg')}}" alt="img">
                            ...
                            <p>
                           Encourage the development of innovative products and technologies that utilize DRC's mineral resources, such as new materials for electronics 
                            </p>
                            <a href="Javascript:void(0);" class="theme-btn-2 mt-3">
                                read More
                                <i class="fa-solid fa-arrow-right-long"></i>
                            </a>
                        </div>
    ...
    <section class="achievement-section-3 fix section-bg-2">
        <div class="shape-image">
            <img src="{{url('img/achiv-shape.png')}}" alt="shape-img">
        </div>
        <div class="container">
            <div class="achievement-wrapper style-2">
                <div class="section-title mb-0">
                    ...
                    <h2 class="text-white wow fadeInUp" data-wow-delay=".3s">
                        Your Gateaway  to Congo's Tech Revolution
                    </h2>
                </div>
                <div class="counter-area">
                    <div class="counter-items wow fadeInUp" data-wow-delay=".3s">
                        <div class="icon">
                            <img src="{{url('img/achievement-icon/01.svg')}}" alt="icon-img">
                        </div>
                        <div class="content">
                    ...
                    <div class="counter-items wow fadeInUp" data-wow-delay=".5s">
                        <div class="icon">
                            <img src="{{url('img/achievement-icon/02.svg')}}" alt="icon-img">
                        </div>
                        <div class="content">
                    ...
                    <div class="counter-items wow fadeInUp" data-wow-delay=".7s">
                        <div class="icon">
                            <img src="{{url('img/achievement-icon/03.svg')}}" alt="icon-img">
                        </div>
                        <div class="content">
                    ...
                    <div class="counter-items wow fadeInUp" data-wow-delay=".9s">
                        <div class="icon">
                            <img src="{{url('img/achievement-icon/04.svg')}}" alt="icon-img">
                        </div>
                        <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="about-image">
                            ...
                            <img src="{{url('img/about/5-2.png')}}" alt="about-img">
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="about-content">
                            <div class="section-title">
                                <span class="wow fadeInUp"> Enjeux des  minerais de la RDC et 
                                    la Modernisation Technologique
                                </span>
                             <strong>1. Le rôle de la RDC dans la chaîne de valeur mondiale</strong>
                             </br>La RDC est un acteur incontournable dans l'approvisionnement mondial en minerais critiques.</br>
                             <strong>2. Minerais pour les énergies renouvelables</strong></br> 
                             Les minerais congolais jouent un rôle crucial dans la transition énergétique
                             vers les énergies renouvelables (batteries pour les véhicules électriques,panneaux solaires).</br> 
                             <strong>3. Minerais pour les énergies renouvelables</strong></br> 
                             Il est essentiel de favoriser le transfert de technologies vers la RDC pour renforcer les capacités
                            locales et développer un secteur minier plus durable.</br> 
                            <strong>4. Développement économique et social</strong></br> 
                            L'exploitation minière peut générer des revenus importants pour le
                            pays et contribuer à son développement économique.
    ...
    <!--<< Team Section Start >>-->
    <section class="team-section-3 text-white fix py-5 section-bg" style="background-color: #05054f">
        <div class="container">
            <div class="section-title-area text-white ">
                <div class="section-title">

                    <h2 class="wow fadeInUp text-white" data-wow-delay=".3s" id="team">
            ...
            <div class="section-title my-0 py-0 ">
                <span class="wow fadeInUp text-white">Founder</span>
            </div>
            <div class="row my-0 py-0">
                <div class="col-xl-4 wow fadeInUp" data-wow-delay=".3s">
                    <div class="single-team-items d-flex my-0 py-0">
                        
                        @foreach($users as $user)
                            @if($user->role === 'FOUNDER' && $user->name !== 'Admin')
                                <div class="team-image h-25">
                                    <img src="{{url('storage/'.$user->image)}}" alt="team-img" style="position: relative; border-radius: 100%; width: 100px; height: 100px">
                                </div>
                                <div class="team-content text-center bg-transparent text-dark text-dark">
                                    <h4 class="text-white">
                                        <a href="Javascript:void(0);" class="text-white">{{ $user->name. ' '. $user->lastname }}</a>
                                    </h4>
                                </div>
                            @endif
                        @endforeach
    ...
    <!--<< Team Section Start >>-->
    <section class="team-section-3 fix section-bg py-5">
        <div class="container">
            <div class="section-title my-0 py-0 ">
                <span class="wow fadeInUp">Co-Founders</span>
            </div>
            <div class="row my-0 py-0">
                @foreach($users as $user)
                    @if($user->role === 'CO-FOUNDER')
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-team-items d-flex">
                            <div class="team-image h-25">
                                <img src="{{url('storage/'.$user->image)}}" alt="team-img" style="position: relative; border-radius: 100%; width: 100px; height: 100px">
                            </div>
                            <div class="team-content text-center bg-transparent text-dark text-dark">
                                <h4 class="text-dark">
                                    <a href="Javascript:void(0);" class="text-dark">{{ $user->name. ' '. $user->lastname }}</a>
                                </h4>
                            </div>
                        </div>
                    </div>
    ...
    <!--<< Team Section Start >>-->
    <section class="team-section-3 text-white fix section-bg py-5" style="background-color: #05054f">
        <div class="container">
            <div class="section-title my-0 py-0 ">
                <span class="wow fadeInUp text-white">Advisory Boards</span>
            </div>
            <div class="row my-0 py-0">
                @foreach($users as $user)
                    @if($user->role === 'ADVISORY BOARDS')
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-team-items d-flex">
                            <div class="team-image h-25">
                                <img src="{{url('storage/'.$user->image)}}" alt="team-img" style="position: relative; border-radius: 100%; width: 100px; height: 100px">
                            </div>
                            <div class="team-content text-center bg-transparent">
                                <h4>
                                    <a href="Javascript:void(0);" class="text-white">{{ $user->name. ' '. $user->lastname }}</a>
                                </h4>
                            </div>
